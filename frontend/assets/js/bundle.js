...
var SHOW_ERROR_MESSSAGES = 'show-error-message';
...
function hideErrorMessages(form) {
    form.querySelectorAll('.' + SHOW_ERROR_MESSSAGES).forEach(function (item) { return item.classList.remove(SHOW_ERROR_MESSSAGES); });
}
function showErrorMessage(input, msg) {
    var formFields = input.parentElement; // Seleciona o pai do input e o joga em uma constante
    var errorMessage = formFields.querySelector('.error-message'); // Seleciona tag span da formField
...
function shouldSendForm(form) {
    var send = true;
    form.querySelectorAll('.' + SHOW_ERROR_MESSSAGES).forEach(function () { return (send = false); });
    return send;
}
